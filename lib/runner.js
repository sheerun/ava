...
var optionChain = require('../vendor/node_modules/option-chain');
var matcher = require('../vendor/node_modules/matcher');
...
optionChain(chainableMethods, function (opts, title, fn) {
	...
	if (opts.todo) {
		...
		if (typeof title !== 'string') {
			throw new TypeError('`todo` tests require a title');}} else 
