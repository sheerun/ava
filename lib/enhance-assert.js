...
function enhanceAssert(opts) {
	var empower = require('../vendor/node_modules/empower-core');
...
function formatter() {
	var powerAssertFormatter = require('../vendor/node_modules/power-assert-formatter');
	var powerAssertRenderers = require('../vendor/node_modules/power-assert-renderers');
